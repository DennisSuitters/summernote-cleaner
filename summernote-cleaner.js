                    ...
                    var button = ui.button({
                        ...
                        click: function () {
                            if ($note.summernote("createRange").toString())
                                ...
                                $note.summernote(
                                    "code",
                                    cleanText($note.summernote("code"))
                                );
                    ...
                    if (
                        ...
                        if (
                            ...
                            $editor
                                .find(".note-status-output")
                                .html(
                                    '<small class="cleanerLimit pull-right ' +
                                        lengthStatus +
                                        "&nbsp;</small>"
                                );
                        }
                ...
                "summernote.paste": function (we, e) {
                    if (
                        ...
                        if (msie)
                            ...
                            var text = e.originalEvent.clipboardData.getData(
                        ...
                        if (text) {
                            if (msie || ffox)
                                setTimeout(function () {
                                    $note.summernote(
                                        "pasteHTML",
                                        cleanText(text, options.cleaner.newline)
                                    );
                                }, 1);
                            else
                                $note.summernote(
                            ...
                            if ($editor.find(".note-status-output").length > 0)
                                $editor
                                    .find(".note-status-output")
                                    .html(
                                        '<div class="summernote-cleanerAlert alert alert-success">' +
                                            lang.cleaner.not +
                                            "</div>"
                                    );
                            else
                                $editor
                                    .find(".note-resizebar")
                                    .append(
                                        '<div class="summernote-cleanerAlert alert alert-success" style="' +
                                            options.cleaner.notStyle +
                                            '">' +
                                            lang.cleaner.not +
                                            "</div>"
