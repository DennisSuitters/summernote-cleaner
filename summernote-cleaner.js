...
(function($){
    ...
    $.extend($.summernote.options,{
        element:'.summernote',
        time:900,
        action:'button', // Currently not in use until I work out how to capture pasted content // both|button|paste
        cleaner:{
                ...
                context.memo('button.cleaner',function(){
                    var button=ui.button({
                        ...
                        click:function(){
                            ...
                            $('.note-cleaner .btn').addClass('btn-success');
                            setTimeout(function(){$('.note-cleaner .btn').removeClass('btn-success');},options.time);
                        }
                    });
